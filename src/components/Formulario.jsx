...
const Formulario = ({pacientes, setPacientes, paciente, setPaciente}) => {
    ...
    const generarId = () =>{
        const random = Math.random().toString(36).substr(2);        //numero al azar, lo  paso a letras y elimino el "0." del inicio
        ...
        <div className="md:w-1/2 lg:w-2/5 mx-5">
            ...
            { error && <Error><p>Todos los campos son obligatorios</p></Error> }
                ...
                <div className="mb-5">
                    ...
                    <input id="email" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md" type="email" placeholder="E-mail contacto propietario" value={email} onChange={(e)=> setEmail(e.target.value)} />
                </div>
                ...
                <div className="mb-5">
                    <label htmlFor="sintomas" className="block text-gray-700 uppercase font-bold" placeholder="Describe los sintomas">Sintomas</label>
                    <textarea id="sintomas" className="w-full" value={sintomas} onChange={(e)=> setSintomas(e.target.value)}></textarea>
                </div>
